...
* **Theme:** Dark mode (`#0f1115` base with `#4c8dff` accent).
* **Feedback:** Hover and active states for buttons, cross-out styling for completed items.

## 💡 What I Learned

During this project, I strengthened my understanding of:
1. DOM manipulation (`createElement`, `appendChild`, `classList.toggle`).
